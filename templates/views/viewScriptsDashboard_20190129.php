                                        ...
                                        [
                                            ...
                                            },
                                            {
                                                ...
                                                formatter: function(value){
                                                    ...
                                                    if(row.assignedto!=null){
                                                        if(value!=null){
                                                            text = "<div class='col-lg-10 input-group date'><input type='text' id=part"+parts[index_part].part+"  class='form-control fixdate' placeholder='Date of delivery' value="+value+"> <span class='input-group-addon'><span class='glyphicon glyphicon-calendar'></span></div>";        
                                                        }else{
                                                            text = "<div class='col-lg-10 input-group date'><input type='text' id=part"+parts[index_part].part+"  class='form-control fixdate' placeholder='Date of delivery'> <span class='input-group-addon'><span class='glyphicon glyphicon-calendar'></span></div>";
           ...
           $('#tab-parts').click(function(){
            ...
            $("#myModalPartsRequesition #buttonAddParts").click(function(){
				...
				if ($("#myModalPartsRequesition #parts").val()=='' || $("#myModalPartsRequesition #seg").val()=='' || $("#myModalPartsRequesition #description").val()=='' || $("#myModalPartsRequesition #qty").val()=='') {
					...
					part = {seg:$("#myModalPartsRequesition #seg").val(), parts:uniquepart, description:$("#myModalPartsRequesition #description").val(), qty:$("#myModalPartsRequesition #qty").val(), ord:$("#myModalPartsRequesition #parts").val(), delete:$("#myModalPartsRequesition #parts").val(), date_of_delivery:$("#myModalPartsRequesition #dateofdelivery").val(), comments_parts:$("#myModalPartsRequesition #commentsparts").val()};
					parts.push(part);
            ...
            $("#modal-edit #buttonAddPartsE").click(function(){
				...
				if ($("#modal-edit #edit-parts").val()=='' || $("#modal-edit #edit-description").val()=='' || $("#modal-edit #edit-qty").val()=='') {
					...
					newPart = {idrequest: uniquepart, seg:$("#modal-edit #edit-seg").val(), part:$("#modal-edit #edit-parts").val(), description:$("#modal-edit #edit-description").val(), quantity:$("#modal-edit #edit-qty").val(), ord:'1',date_of_delivery:$("#modal-edit #editdateofdelivery").val(), comment_parts:$("#modal-edit #commentspartsedit").val(), edit:$("#modal-edit #idRequest").val() + "|" + $("#modal-edit #edit-parts").val(), delete:$("#modal-edit #idRequest").val() + "|" + $("#modal-edit #edit-parts").val()};
