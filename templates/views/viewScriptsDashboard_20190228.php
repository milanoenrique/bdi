                                                    ...
                                                    index_part = index_part+1;
                                                     if(typeof parts[index_part].allcoments!=='undefined'){
                                                        parts[index_part].allcoments.forEach(function(element){
                                                           comment_temp += element.comment+'&#10;';
                                                    });
                                                    }
                                                    
                                                    var text;
                                                    text = '<div title="'+comment_temp+'" class="red-tooltip" data-toggle="tooltip"><i class="fa fa-comments"></i></div><div><textarea id=c-'+parts[index_part].part+ '   rows=3 maxlength=100 class="comments_parts" disabled>'+value+'</textarea></div>';
                                                    index_part = index_part-1;
                                                    comment_temp='';
                                                    return text;
                                                }
                                                    ...
                                                    //console.log("select: "+JSON.stringify(parts));
                                                        ...
                                                        if(row.assignedto!=null){
                                                            ...
                                                            if(parts[index_part].ord=='received'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part" disabled><option value="ordered">Ordered</option><option value="received" selected="true">Received</option><option " value="canceled">Canceled</option></select>';
                                                            }
                                                            if(parts[index_part].ord=='canceled'){



                                                                    text = '<select id='+parts[index_part].part+'class="status_part" disabled><option value="ordered">Ordered</option><option value="received">Received</option><option value="canceled" selected="true">Canceled</option></select>'
                                                            }
