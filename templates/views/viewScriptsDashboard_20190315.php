                                                        ...
                                                        if(row.assignedto!=null){
                                                            ...
                                                            if(parts[index_part].ord=='1'){
                                                              ...
                                                              if(parts[index_part].ord=='ordered'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part secure"><option selected="true" value="ordered">Ordered</option><option value="quoted">Quoted</option>';
                                        ...
                                        if(field === "delete")
                                        {
                                            ...
                                            newParts = parts.filter(function(el)
                                            {
                                                ...
                                                if(row.ord=='received' || row.ord=='quoted'){
                                                    ...
                                                    if(row.comment_parts!=$('#c-'+row.part).val() && $('#c-'+row.part).val() !=''){
                                                        var x;
                                                         x= deletedParts.indexOf(value);
                                                        if(x==-1){
                                            ...
                                            if(flag==false){
                                                 alert("Please insert a comment before delete this part");
                                            ...
                                            if(parts.length==0){
                                                alert("An request must containet at least a part");
           ...
           $('#tab-parts').click(function(){
			...
			$("#modal-edit #buttonSave").click(function(event){
              ...
              //  console.log(partsJSON);
                ...
                if(ro!=compare_order.ro || vin!=compare_order.vin || comments!=compare_order.comments || engine != compare_order.engine || parts.length !=compare_order.parts ){
