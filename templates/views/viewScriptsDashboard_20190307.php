        ...
        $(document).ready(function(){
                                                    ...
                                                    //console.log("select: "+JSON.stringify(parts));
                                                        ...
                                                        if(row.assignedto!=null){
                                                            ...
                                                            if(parts[index_part].ord=='ordered'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part"><option selected="true" value="ordered">Ordered</option><option value="received">Received</option><option value="canceled">Canceled</option><option value="quote">Quote</option></select>';


                                                            }
                                                            if(parts[index_part].ord=='received'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part" disabled><option value="ordered">Ordered</option><option value="received" selected="true">Received</option><option " value="canceled">Canceled</option><option value="quote">Quote</option></select>';
                                                            }
                                                            if(parts[index_part].ord=='canceled'){



                                                                    text = '<select id='+parts[index_part].part+'class="status_part" disabled><option value="ordered">Ordered</option><option value="received">Received</option><option value="canceled" selected="true">Canceled</option><option value="quote">Quote</option></select>'
                                                            }

                                                              if(parts[index_part].ord=='quote'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part" disabled><option value="ordered">Ordered</option><option value="quote" selected="true">Quote</option><option " value="canceled">Canceled</option><option value="quote">Quote</option></select>';
                                                            }

                                                            if(parts[index_part].ord=='1'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part"><option value="1">Select an option</option><option value="ordered">Ordered</option><option value="received">Received</option><option value="canceled">Canceled</option><option value="quote">Quote</option></select>'
                                                            }
                                                            return text;
                                            ...
                                            $('#modal-edit').on('change','select.status_part', function(e){
                                                ...
                                                if (add_class){
                                                 ...
                                                 if($(this).val()=='canceled'){
                                                    ...
                                                    $('#c-'+$(this).attr('id')).addClass('comment_require');
                                                    $('#c-'+$(this).attr('id')).removeClass('comment_parts');
                                                }
                                                else{
                                                    
                                                    $('#c-'+$(this).attr('id')).removeClass('comment_require');
                                                    $('#c-'+$(this).attr('id')).addClass('comment_parts');
                                                }
                                              });
                                        }
           ...
           $('#tab-parts').click(function(){
			...
			$("#modal-edit #buttonSave").click(function(event){
                ...
                $('.comment_require').each(function(){
                    if($(this).val()==''){
                        y++;                       
                    }else{
                        var id_temp_h= '';
                        id_temp_h = $(this).prop('id');
                        id_temp_h = id_temp_h.replace('c-','h-');
                        if($('#'+id_temp_h).val()==$(this).val()){
                            y++;
                ...
                if(z>0 || y>0){
                    ...
                    if (y>0){
                        alert("The Comment it's require for parts with status canceled");                                 
                    }
                ...
                partsJSON   = JSON.stringify(parts)+"||"+ordParts+"*|||"+JSON.stringify(newPart_edit)+"||||"+JSON.stringify(date_of_delivery)+ "|||||"+JSON.stringify(comment_canceled);
                date_of_delivery={};
                comment_canceled = [];
