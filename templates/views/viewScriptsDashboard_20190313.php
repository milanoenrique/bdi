                                                    ...
                                                    //console.log("select: "+JSON.stringify(parts));
                                                        ...
                                                        if(row.assignedto!=null){
                                                            ...
                                                            if(parts[index_part].ord=='1'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part secure"><option value="1">Select an option</option><option value="quoted">Quoted</option></select>'
                                                            }
           ...
           $('#tab-parts').click(function(){
			...
			$("#modal-edit #buttonSave").click(function(event){
              ...
              //  console.log(partsJSON);
                ...
                if(ro!=compare_order.ro || vin!=compare_order.vin || comments!=compare_order.comments || parts.length !=compare_order.parts ){
