        ...
        $(document).ready(function(){
            ...
            $("#modal-edit #buttonAddPartsE").click(function(){
				...
				if ($("#modal-edit #edit-parts").val()=='' || $("#modal-edit #edit-description").val()=='' || $("#modal-edit #edit-qty").val()=='') { 
					...
					newPart = {idrequest: uniquepart, seg:$("#modal-edit #edit-seg").val(), part:$("#modal-edit #edit-parts").val(), description:$("#modal-edit #edit-description").val(), quantity:$("#modal-edit #edit-qty").val(), ord:'0', edit:$("#modal-edit #idRequest").val() + "|" + $("#modal-edit #edit-parts").val(), delete:$("#modal-edit #idRequest").val() + "|" + $("#modal-edit #edit-parts").val()};
					parts.push(newPart);
