	<script>
                                            ...
                                            $('#modal-edit').on('change','select.status_part', function(e){
                                                ...
                                                if (add_class){
                                                 ...
                                                 if($(this).val()=='canceled'){
                                                    ...
                                                    $('#c-'+$(thvis).attr('id')).addClass('comment_parts');
                                                    var ejmg = require_date.indexOf($(this).attr('id'));
                                                    require_date.splice(ejmg,1);
                                                }
       ...
       $('#modal-edit #table-parts ,secure').keypress(function(){
        $(".modal-footer #buttonSave").removeAttr('disabled');
