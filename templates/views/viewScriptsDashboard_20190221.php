                                        ...
                                        [
                                            ...
                                            },
                                            {
                                                ...
                                                formatter: function(value){
                                                    ...
                                                    text = '<div  class="red-tooltip" data-toggle="tooltip" title='+value+'>'+value2+'</div>';
                                        ...
                                        [
                                            ...
                                            },
                                            {
                                                ...
                                                formatter: function(value){
                                                    ...
                                                    var text;
                                                    text = '<textarea id=c-'+parts[index_part].part+ ' disabled value='+value+' rows=3 maxlength=100></textarea>';
                                                    index_part = index_part-1;
                                                    return text;
                                                }
                                            },
                                            ...
                                            $('#modal-edit').on('change','select.status_part', function(e){
                                                ...
                                                if (add_class){
                                                 ...
                                                 if($(this).val()=='canceled'){
                                                    ...
                                                    $('#c-'+$(this).attr('id')).prop('disabled','disabled');
