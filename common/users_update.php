<?php 
    ...
    $sth = $dbh->prepare("SELECT * FROM user_update2(:iduser, :surname, :lastname, :password, :idusertype, :appuser, :idrol, :phonenum, :groups);");
    ...
    $sth->bindParam(':groups',      $groups,        PDO::PARAM_STR|PDO::PARAM_INPUT_OUTPUT);
