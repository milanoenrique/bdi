                                        ...
                                        <center>
                                            <div class="panel-body" id="partsRequesition">
                                                <form class="form-horizontal" style="text-align: left;" data-toggle="validator">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label" for="requestType">Type </label>
                                                        <div class="col-md-9  inputGroupContainer" style="padding-right: 0;">
															<label class="btn " ><input type="radio" name="requestType" value="O" checked>Order</label>														
															<label class="btn " ><input type="radio" name="requestType" value="Q">Quote</label>
                                                        </div>
                                                    </div>													
                                                    <div class="form-group">
                                            ...
                                            <div class="panel-body" id="partsRequesition">
                                                <form class="form-horizontal" style="text-align: left;">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label" for="requestType">Type </label>
                                                        <div class="col-md-9  inputGroupContainer" style="padding-right: 0;">
															<label class="btn " ><input type="radio" name="requestType" value="O">Order</label>														
															<label class="btn " ><input type="radio" name="requestType" value="Q">Quote</label>
                                                        </div>
                                                    </div>													
                                                    <div class="form-group">
	...
	<script src="js/jquery-1.11.2.min.js"></script>
		...
		$("#myModalSendMessage #buttonSendMessage").click(function()
				...
				window.location.replace("http://reqparts.bdicalgary.com/BrandellDiesel/index.php");
					...
					// Manage Type Orders NEW Request
					...
					$("#myModalPartsRequesition #buttonSavePartsRequesition").click(function()
					{
						...
						var $radiotype = $('.modal-body input:radio[name="requestType"]');	
				...
				// Manage Type Orders EDIT Request
				$('#modal-edit input:radio[name="requestType"]').change(function(){
					if ($(this).val() == "O") {
						$("#modal-edit #priority").prop("disabled", false);					
					}
					else
					{
						$("#modal-edit #priority").prop( "checked", false );	
						$("#modal-edit #priority").prop("disabled", true);
					}  
				});					
				...
				$("#modal-edit #buttonSave").click(function()
                {
					...
					var $radiotype = $('#modal-edit input:radio[name="requestType"]');	
					idrequesttype = $radiotype.val();		
