...
?>
            ...
            <div class="row">
                <div class="panel panel-default" id="print-dashboard">
                    <div class="panel-heading" style="padding-bottom: 80px;background:#191919;">
    				<font color='#fff'>
    					<div class="col-xs-12 text-center" id="one">
    						...
    						<div class="col-xs-6 text-left" id="two">
    							<font color='#fff'>
                                        ...
                                        <div>
                                        <span>Close to be Expired: </span><span class="fa fa-circle" style="color:yellow;"></span><span id="yellow"></span>
                                        </div>
                                        <div>
                                        <span>Ordered: </span><span class="fa fa-circle" style="color:orange;"></span><span id="orange"></span>
                                        </div>                                       
                                        <div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="buttonSaveWriteUp" class="btn btn-primary buttonSaveWriteUp" data-typerecord="save" style="background:#2C3E50;border-color:#2C3E50;">Save</button> 
                        </div>                        
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="buttonSave" type="button" class="btn btn-primary buttonSaveWriteUp" data-typerecord="update" style="background:#2C3E50;border-color:#2C3E50;">Save</button>
                            <button id="buttonSaveClose" type="button" class="btn btn-primary buttonSaveWriteUp" data-typerecord="saveclose" style="background:#2C3E50;border-color:#2C3E50;">Save & Close</button>
                        </div>                  
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="panel-body" id="partsRequesition">
                                                <form class="form-horizontal" style="text-align: left;" data-toggle="validator">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-10" style="padding-right: 4%">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-2 input-group date" id="datetimepickerEndDate">
                                            ...
                                            <div class="panel-body" id="partsRequesition">
                                                <form class="form-horizontal" style="text-align: left;">
                                                    ...
                                                    <div class="form-group">                                                        
                                                        ...
                                                        <div class="col-lg-2 input-group date" id="datetimepickerdeliveryDate">
